...
select throws_ok($$insert into public.buildings(condominium_id,name,created_by) values ('22000000-0000-0000-0000-000000000002','x','00000000-0000-0000-0000-0000000000a1')$$,'42501','A cannot create building in B');
...
select throws_ok($$insert into public.buildings(condominium_id,name,created_by) values ('22000000-0000-0000-0000-000000000002','No','00000000-0000-0000-0000-0000000000b1')$$,'42501','owner cannot manage structure');
