...
select throws_ok($$update public.notification_events set aggregate_id='a7000000-0000-0000-0000-000000000001' where id=(select id from public.notification_events limit 1)$$,'notification events are immutable','event identity immutable'); -- 52
