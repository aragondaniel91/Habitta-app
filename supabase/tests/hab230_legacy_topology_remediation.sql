...
select throws_ok($$select public.remediate_condominium_topology('23020000-0000-4000-8000-000000000008','mixed',null,null)$$,'42501','permission denied','accountant denied');
select set_config('request.jwt.claim.sub','23000000-0000-4000-8000-000000000004',true);
select throws_ok($$select public.remediate_condominium_topology('23020000-0000-4000-8000-000000000008','mixed',null,null)$$,'42501','permission denied','assistant denied');
select set_config('request.jwt.claim.sub','23000000-0000-4000-8000-000000000005',true);
select throws_ok($$select public.remediate_condominium_topology('23020000-0000-4000-8000-000000000008','mixed',null,null)$$,'42501','permission denied','outsider denied');
