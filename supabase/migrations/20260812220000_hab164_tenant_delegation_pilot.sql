...
-- Staff see the whole condominium, owners only their active ownership links, and pilot tenants
-- only active tenant occupancies. Expired ownership and occupancy relationships never preserve
-- resident unit access.
