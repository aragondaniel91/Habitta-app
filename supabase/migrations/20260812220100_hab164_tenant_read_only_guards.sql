...
-- `can_submit_payment` is used by both financial read policies and payment creation.
-- Tenant-only users receive no implicit owner financial authority. Existing owner/staff and
