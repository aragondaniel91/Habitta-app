...
| Unidades | Units V3 editor + Structure Management topology/building editor | compliant | Sí | Sí | Sí | Sí | FormGrid 2→1, workspace Drawer y acciones sticky | No encontrado | Completada | Conserva topología, UUIDs de edificio, archivo no destructivo, historial de propiedad/ocupación y validación de alícuota. |
